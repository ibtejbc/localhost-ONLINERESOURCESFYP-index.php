...
$result = mysql_query("SELECT Room, Username, StartDate, EndDate, StartTime, EndTime, Status FROM Booking WHERE ( Room = 'AV Room' AND StartDate = '2018-03-01')");
...
<center>
<input type="button" onClick="location = 'ViewBooking.php'" value="Previos">
<input type="button" onClick="location = 'Saturday303AVRoom.php'" value="Next"></center>
