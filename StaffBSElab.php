...
//$result = mysql_query("SELECT * FROM Booking WHERE Room = 'BSE Lab'");



$result = mysql_query("SELECT * FROM Booking WHERE Room = 'BSE Class Room' ORDER BY 'Start Date' DESC");


echo "<table border = '2'> <table id = resource>
<br><br>
<center><b>List All BSE Class Room Resources Booking </center>
<br> <br>
