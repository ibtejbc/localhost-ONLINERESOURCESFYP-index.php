...
$result = mysql_query("SELECT * FROM ListResources WHERE Department = 'SICT Department' ORDER BY RoomID");
echo "<table border = '2'> <table id = resource>
<br><br>
<center><b>List Of School Of SICT Department<center>
<br> <br>
<tr>
<th>ROOM ID</th>
<th>ROOM</th>
...
#resource tr:nth-child(even){background-color: #FA5A5A;}
#resource tr:nth-child(odd){background-color: #E57979;}
