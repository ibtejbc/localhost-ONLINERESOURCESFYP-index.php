...
<form action = "CancelAllStaffBooking.php" method = "post"> 
<br><input type = "text" name = "Search" placeholder = "Enter Your Booking ID" autofocus autocomplete = "off"> <br> <br> <input type = "submit" name = "submit" value = "Search" ></br>
