...
$result = mysql_query("SELECT * FROM ListResources WHERE Department = 'BMA Department' ORDER BY RoomID");
echo "<table border = '2'> <table id = resource>
<br><br>
<center><b>List Of Building Marine Engineering Department<center>
<br> <br>
<tr>
<th>ROOM ID</th>
<th>ROOM</th>
...
#resource tr:nth-child(even){background-color: #86E1D5;}
#resource tr:nth-child(odd){background-color: #ABA5A5;}
