...
<tr>
<td><center><input type = "varchar" name = "StudentID" required autofocus autocomplete = "off" placeholder = "Eg.S1" /></td></tr>
...
<td><center><input type = "varchar" name = "Firstname" placeholder = "Firstname" required autofocus autocomplete = "off" /></td></tr>
...
<td><center><select name = "Course" id = "Course" required autofocus autocomplete = "off">
...
<tr> <td> <center> <input type="submit" class="button" value="Submit">
	...
	<input type="button" onClick="location = 'SearchStudentRegistration.php'" value="Search & Delete">
    <input type="button" onClick="location = 'SearchEditStudentRegistration.php'" value="Search & Edit"> </td> </tr>
