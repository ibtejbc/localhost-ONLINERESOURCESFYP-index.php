...
$result = mysql_query("SELECT * FROM ListResources WHERE Department = 'BSE Department' ORDER BY RoomID");
echo "<table border = '2'> <table id = resource>
<br><br>
<center><b>List Of Buildng Services Engineering Department<center>
<br> <br>
<tr>
<th>ROOM ID</th>
<th>ROOM</th>
...
#resource tr:nth-child(even){background-color: #A3A92F;}
#resource tr:nth-child(odd){background-color: #EBF083;}
