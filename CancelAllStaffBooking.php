...
<center>
<br><br><br>
<form action = "CancelAllStaffBookingButton.php" method = "post">
...
Department: <input type = "text"  autofocus autocomplete = "off"name = "Email" value="<?php echo $Email; ?>" readonly /><br><br>
