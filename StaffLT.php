...
<tr>
<th> <input type="button" onClick="location = 'StaffScheduleBooking.php'" value="AV Room"></th>
<th> <input type="button" onClick="location = 'StaffBSElab.php'" value="BSE ClassRoom"></th>
<th> <input type="button" onClick="location = 'StaffComputerlab.php'" value="PLC Instrument Lab"></th>
<th> <input type="button" onClick="location = 'StaffLT.php'" value="Literature Theater"></th>
<th> <input type="button" onClick="location = 'StaffPLElab.php'" value="CSD Room"></th>
<th> <input type="button" onClick="location = 'StaffSurau.php'" value="Surau"></th>
</table>
...
//$result = mysql_query("SELECT * FROM Booking WHERE Room = ''. AND StartDate = '2018-02-28'");
...
//$result = mysql_query("SELECT * FROM Booking WHERE Room = 'Literature Theater'");

$result = mysql_query("SELECT * FROM Booking WHERE Room = 'Literature Theater' ORDER BY 'Start Date' DESC");

echo "<table border = '2'> <table id = resource>
<br><br>
<center><b>List All Literature Theatre Room Resources Booking </center>
<br> <br>
