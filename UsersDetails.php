...
<tr><td><center><input type="button" onClick="location = 'Staffcategory.php'" value="Staff Category"></td>
<td><center><input type="button" onClick="location = 'Studentcategory.php'" value="Student Category"></td></center> </table><br>
...
echo "<table border = '2'> <table id = customers>
<br> <br>
<center>List Of Student Records From Registration </center>
<br> <br>
<tr>
<th>Student ID</th>
<th>USERNAME</th>
