...
//$result = mysql_query("SELECT * FROM Booking WHERE Room = 'Computer Lab'");

$result = mysql_query("SELECT * FROM Booking WHERE Room = 'PLC Instrument Lab' ORDER BY 'Start Date' DESC");


echo "<table border = '2'> <table id = resource>
<br><br>
<center><b>List All PLC Instrument Lab Resources Booking </center>
<br> <br>
