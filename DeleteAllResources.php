...
<center>
<br><br>
<form action = "DeleteSearchResources.php" method = "post">
<b>Room ID: <input type = "text" name = "RoomID" value="<?php echo $query; ?>"/><br><br>
Room: <input type = "text" name = "Room" value="<?php echo $Room; ?>"/><br><br>
Department: <input type = "text" name = "Department" value="<?php echo $Department; ?>"/><br><br>
LevelFloor: <input type = "text" name = "LevelFloor" value="<?php echo $LevelFloor; ?>"/><br><br>
GroupCode: <input type = "text" name = "Course" value="<?php echo $Course; ?>" /><br><br>
StaffinCharge: <input type = "text" name = "StaffinCharge" value="<?php echo $StaffinCharge; ?>" /><br><br></b>
