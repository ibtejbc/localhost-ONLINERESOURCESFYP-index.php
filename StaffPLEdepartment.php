...
$result = mysql_query("SELECT * FROM ListResources WHERE Department = 'PLE Department'");
echo "<table border = '2'> <table id = resource>
<br><br>
<center><b>List Of Plant Engineering Department<center>
<br> <br>
<tr>
<th>ROOM ID</th>
<th>ROOM</th>
...
#resource tr:nth-child(even){background-color: #AB6AD7;}
