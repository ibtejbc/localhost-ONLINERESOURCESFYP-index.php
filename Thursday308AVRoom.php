...
$result = mysql_query("SELECT Room, Username, StartDate, EndDate, StartTime, EndTime, Status FROM Booking WHERE ( Room = 'AV Room' AND StartDate = '2018-03-08')");

echo "<table border = '2'> <table id = resource>
<br><br>
<center><b>List All AV Room Resources Booking </center>
<br> <br>
Wednesday, 7 March 2018<br>
...
<center>
<input type="button" onClick="location = 'Tuesday306AVRoom.php'" value="Previos">
<input type="button" onClick="location = 'Thursday308AVRoom.php'" value="Next"></center>
...
<br><br><br>
<center>WILL BE KEEP ON UPDATE!</center>

<input type="button" onClick="location = 'Wednesday307AVRoom.php'" value="Previos">