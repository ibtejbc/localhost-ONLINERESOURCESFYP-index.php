...
//$result = mysql_query("SELECT * FROM Booking WHERE StartDate = '2018-03-01'");
...
$result = mysql_query("SELECT Room, Username, StartDate, EndDate, StartTime, EndTime, Status FROM Booking WHERE ( Room = 'Surau' AND StartDate = '2018-03-01')");

echo "<table border = '2'> <table id = resource>
<br><br>
<center><b>List All BSE Lab Room Resources Booking </center>
<br> <br>
...
<br><br>
<center>
<input type="button" onClick="location = 'BSElab.php'" value="Previous">
<input type="button" onClick="location = 'Monday105BSE.php'" value="Next">
