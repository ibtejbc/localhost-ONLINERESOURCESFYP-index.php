...
<center>
<br><br><br>
<form action = "EditAllStudentBookingButton.php" method = "post">
...
Room: <input type = "varchar" name = "Room" value="<?php echo $Room; ?>" /><br><br>
Start Date: <input type = "date" name = "RequestStartDate" value="<?php echo $RequestStartDate; ?>" /><br><br>
End Date: <input type = "date" name = "RequestEndDate" value="<?php echo $RequestEndDate; ?>" /><br><br>
Start Time: <input type = "text" name = "RequestStartTime" value="<?php echo $RequestStartTime; ?>" /><br><br>
End Time: <input type = "text" name = "RequestEndTime" value="<?php echo $RequestEndTime; ?>" /><br><br>
Request Send To: <input type = "varchar" name = "RequestSendTo" value="<?php echo $RequestSendTo; ?>" /><br><br>
Reason: <input type = "varchar" name = "Reason" value="<?php echo $Reason; ?>" /><br><br>
