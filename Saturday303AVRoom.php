...
$result = mysql_query("SELECT Room, Username, StartDate, EndDate, StartTime, EndTime, Status FROM Booking WHERE ( Room = 'AV Room' AND StartDate = '2018-03-03')");

echo "<table border = '2'> <table id = resource>
<br><br>
<center><b>List All AV Room Resources Booking </center>
<br> <br>
Saturday, 3 March 2018<br>
...
<center>
<input type="button" onClick="location = 'Thursday103AVRoom.php'" value="Previos">
<input type="button" onClick="location = 'Monday305AVRoom.php'" value="Next"></center>
