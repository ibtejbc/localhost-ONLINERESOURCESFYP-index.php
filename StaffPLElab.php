...
//$result = mysql_query("SELECT * FROM Booking WHERE Room = 'PLE Lab'");


$result = mysql_query("SELECT * FROM Booking WHERE Room = 'CSD Room' ORDER BY 'Start Date' DESC");


echo "<table border = '2'> <table id = resource>
<br><br>
<center><b>List All CSD Room Resources Booking </center>
<br> <br>
