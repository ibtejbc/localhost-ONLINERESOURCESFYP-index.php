...
$con = mysqli_connect($servername,$username,$password,$dbname);
	...
	$result = mysqli_query($con, "SELECT * FROM Staff WHERE StaffID = '$query'");
...
while ($row = mysqli_fetch_array($result))
{
	...
	$Email = $row ['Email'];
	$PhoneNo = $row ['PhoneNo'];
	$DepartmentCourse = $row ['DepartmentCourse'];
...
<center>
 <br><br>
<form action = "DeleteSearchAllRe.php" method = "post">
<b>User ID: <input type = "text" name = "StaffID" value="<?php echo $query; ?>"/><br><br>
...
Department: <input type = "text" name = "DepartmentCourse" value="<?php echo $DepartmentCourse; ?>" /><br><br></b>
