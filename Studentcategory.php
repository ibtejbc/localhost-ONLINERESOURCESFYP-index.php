...
<td><center><input type="button" onClick="location = 'Staffcategory.php'" value="Staff Category"></td></center>
 <table align = "right">

 <tr>

<th><form action = "DeleteAllFormStudentRegistration.php" method = "post"> 
...
<td><form action = "EditStudentFormRegistration.php" method = "post"> 
...
<b>List Of Student Records From Registration 
<?php
...
$result = mysql_query("SELECT * FROM Student ORDER BY StudentID");
echo "<table border = '2'> <table id = student>
<br> <br>
...
<input type ="button" value = "Print" onClick="window.print()"> </button></center>
