...
<div id="navbar"> 
 ...
 <li><button class="dropbtn">USERS</button> </li>
  <div class="dropdown-content">
    <a href="StaffRegistration.php">REGISTRATION STUDENT</a>
...
$result = mysql_query("SELECT * FROM ListResources WHERE Department = 'ICE Department'");
echo "<table border = '2'> <table id = resource>
<br><br>
<center><b>List Of ICE Department<center>
<br> <br>
<tr>
<th>ROOM ID</th>
<th>ROOM</th>
...
#resource tr:nth-child(even){background-color: #82E0AA ;}
#resource tr:nth-child(odd){background-color: ;}
