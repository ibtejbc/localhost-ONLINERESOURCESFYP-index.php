...
<form action = "EditAllStudentBooking.php" method = "post"> 
<br><input type = "text" placeholder = "Enter Your Booking ID" autofocus autocomplete = "off" name = "Search"> <br> <br> <input type = "submit" name = "submit" value = "Search" ></br>
