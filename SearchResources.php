...
<div class="dropdown-content">
<a href="ViewBooking.php">SCHDEULE BOOKING</a>
...
<br><br>
<h2> Enter Room Name </h2> <center>
<form action = "DeleteAllResources.php" method = "post"> 
<br><input type = "text" name = "Search" placeholder = "Enter Room ID" autofocus autocomplete = "off"> <br> <br> <input type = "submit" name = "submit" value = "Search" ></br>
