...
<div class="dropdown-content">
<a href="ResourcesCategory.php">RESOURES CATEGORY</a>
...
<form action = "DeleteAllFormStudentRegistration.php" method = "post"> 
<br><input type = "text" name = "Search" placeholder = "Eg.S1" autofocus autocomplete = "off"> <br> <br> <input type = "submit" name = "submit" value = "Search" ></br>
